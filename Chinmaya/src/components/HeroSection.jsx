...
const HeroSection = () => {
  ...
  return (
    <section className={`herosection component hero-section min-h-screen flex flex-col justify-center items-center px-2 ${isDarkMode ? 'dark' : ''}`}>
...
<p className="subheading dark:subheading-dark">
  ...
  <a
    href="https://github.com/Chinmaya0011"
    target="_blank"
    rel="noopener noreferrer"
    style={{ color: isDarkMode ? 'white' : 'black' }}
    className="social-icon hover:scale-110 transform transition-transform duration-300 button"
  >
    <FaGithub size={32} />
  </a>
  <a
    href="https://www.linkedin.com/in/finasor/"
    target="_blank"
    rel="noopener noreferrer"
    style={{ color: '#0077B5' }}
    className="social-icon hover:scale-110 transform transition-transform duration-300 button"
  ...
  <a
    href="https://www.hackerrank.com/profile/imchinu17"
    target="_blank"
    rel="noopener noreferrer"
    style={{ color: '#2EC866' }}
    className="social-icon hover:scale-110 transform transition-transform duration-300 button"
  ...
  <a
    href="https://twitter.com/Chinmay67358261"
    target="_blank"
    rel="noopener noreferrer"
    style={{ color: '#1DA1F2' }}
    className="social-icon hover:scale-110 transform transition-transform duration-300 button"
